<?php
    ...
    class Denuncia{
        ...
        public function denunciar($denuncia){
            ...
            $stmt = $conexao->prepare("INSERT INTO tbDenuncia(descDenuncia,tituloDenuncia,dataDenuncia,ufDenuncia,
            logradouroDenuncia,bairroDenuncia,cepDenuncia,fk_idImgDenun,fk_idUsuario,fk_idCategoria)
            VALUES (?,?,?,?,?,?,?,'$idImagem','$teste','$idCat')");

            $stmt->bindValue(1,$denuncia->getDescDenuncia());
            $stmt->bindValue(2,$denuncia->getTituloDenuncia());
