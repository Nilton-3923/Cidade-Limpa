<?php
    ...
    class Usuario{
        ...
        public function denunciasFeita(){
            ...
            $query = "SELECT pk_idImgDenun,pk_idDenuncia,imgDenuncia,nomeUsuario,imgUsuario,tituloDenuncia,descDenuncia,dataDenuncia,cepDenuncia FROM tbDenuncia
        ...
        //Método de Alterar Usuario sem Imagem
        ...
        public function alterarImg($caminhoImagem,$nome,$senha,$id,$tel){
            $conexao = Conexao::pegarConexao();
