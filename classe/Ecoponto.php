<?php
    ...
    class Ecoponto{
        ...
        public function getCidadeEcoponto(){
            return $this->cidadeEcoponto;
        }
        ...
        public function setCidadeEcoponto($cidadeEcoponto){
            $this->cidadeEcoponto = $cidadeEcoponto;
        }
        ...
        public function cadastroEcoponto($ecoponto){
            ...
            $stmt->bindValue(6,$ecoponto->getCidadeEcoponto());
            $stmt->bindValue(7,$ecoponto->geolocalizacao());
            $stmt->bindValue(8,$ecoponto->getZonaEcoponto());
            $stmt->bindValue(9,$ecoponto->getNumeroEcoponto());
