            ...
            <div class="alinhamento-cadastro">
                ...
                <div class="div2">
                    <div class="alinhamento-inputs">
                        <div class="alinhamento-cep">
                            <label>CEP</label>
                            <input autocomplete="off" type="text" name="txtCep" id="cep">
                    ...
                    <div class="alinhamento-inputs">
                        ...
                        <input autocomplete="off" type="text" name="telefone">
                    </div>
                    <div class="alinhamento-inputs">
                        <label>Email</label>
                        <input autocomplete="off" type="text" name="txtEmail">
                    </div>
                </div>
                ...
                <div class="div3">
                    ...
                    <div class="alinhamento-inputs">
                        ...
                        <input id="Csenha"type="password" name="txtSenha">
                    </div>
                </div>
