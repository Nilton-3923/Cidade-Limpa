<!--------NILTON EDITOU PEGAR ESSE CÓDIGO INTEIRO--------->
	...
	<body>
        ...
        <div id="Nao-Resolvida">
            ...
            <form action="../objetos/objeto-alterar-verificacao.php" method="POST">
                ...
                <p>Selecione as denúncias e mande uma mensagem pré selecionada</p>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php
                            ...
                            if($dados['denunciaVerificada'] == "Verificada"){
                                $target = "";
                                $verificada = "Verificada";
                                $input = "<input  type='checkbox'
                                name='id[]'
                                value=".$dados['pk_idDenuncia']."
                            ...
                            ?>
                            <tr>
                                <td data-bs-toggle="modal" data-bs-target="<?php echo $target ?>"><?php echo $dados['pk_idDenuncia']; ?></td>
                                <td data-bs-toggle="modal" data-bs-target="<?php echo $target ?>"><?php echo $dados['campoCategoria']; ?></td>
                                <td data-bs-toggle="modal" data-bs-target="<?php echo $target ?>"><?php echo $dados['dataDenuncia']; ?></td>
                                <td data-bs-toggle="modal" data-bs-target="<?php echo $target ?>"><?php echo $dados['ruaDenuncia']; ?></td>
                                <td data-bs-toggle="modal" data-bs-target="<?php echo $target ?>"><?php echo $dados['bairroDenuncia']; ?></td>
                                <td data-bs-toggle="modal" data-bs-target="<?php echo $target ?>"><?php echo $dados['emailUsuario']; ?></td>
                                <td data-bs-toggle="modal" data-bs-target="<?php echo $target ?>"><?php echo $verificada; ?></td>
                                <td>
                                    <?php echo $input; ?>
                       ...
                       <div class="modal fade" id="exampleModal2<?php echo $dados[0]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="formAdm">
                                        ...
                                        <form action="../cadastro/objeto-resp-adm.php" method="post">
                                            <input type="hidden" name="idDenuncia" value="<?php echo $dados['pk_idDenuncia']; ?>">
                                            <textarea name="respAdm" class="descModal" id="message" type="text" rows="3" placeholder="Comentar..."  data-sb-validations="required"></textarea>
                                    </div>
