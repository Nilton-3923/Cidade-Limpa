...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Maio-2022 às 02:48
...
INSERT INTO `tbdenuncia` (`pk_idDenuncia`, `tituloDenuncia`, `descDenuncia`, `imgDenuncia`, `dataDenuncia`, `ufDenuncia`, `bairroDenuncia`, `cepDenuncia`, `ruaDenuncia`, `cidadeDenuncia`, `coordeDenuncia`, `fk_idUsuario`, `fk_idCategoria`) VALUES
